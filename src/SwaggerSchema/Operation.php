...
class Operation extends ClassStructure
{
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $property093Default = new Schema();
        $property093Default->oneOf[0] = Response::schema();
        $property093Default->oneOf[1] = JsonReference::schema();
        $property093Default->setFromRef('#/definitions/responseValue');
        $properties->responses->setPatternProperty('^([0-9]{3})$|^(default)$', $property093Default);
        $x = new Schema();
        ...
        $properties->responses->setPatternProperty('^x-', $x);
        ...
        $x->description = "Any property starting with x- is valid.";
        $x->setFromRef('#/definitions/vendorExtension');
        $properties->responses->not->setPatternProperty('^x-', $x);
